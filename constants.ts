...
export const PRODUCT_CATEGORIES: ProductCategory[] = [
  ...
  },
  {
    ...
    variants: [
        ...
        {
            id: 'hoodie-gray-zipup',
            name: 'Gray, Zip-Up',
            imageUrl: 'https://picsum.photos/seed/hoodie-gray-zipup/300/300',
            prompt: 'A studio shot of a gray zip-up hoodie, zipped up and laid flat. The provided logo is on the left chest.',
            attributes: { color: 'gray', style: 'Zip-Up' },
        },
        {
        ...
        {
            id: 'hoodie-black-zipup',
            name: 'Black, Zip-Up',
            imageUrl: 'https://picsum.photos/seed/hoodie-black-zipup/300/300',
            prompt: 'A studio shot of a black zip-up hoodie, zipped up and laid flat. The provided logo is on the left chest.',
            attributes: { color: 'black', style: 'Zip-Up' },
        },
        {
            id: 'hoodie-white-pullover',
            name: 'White, Pullover',
            imageUrl: 'https://picsum.photos/seed/hoodie-white-pullover/300/300',
            prompt: 'A clean product shot of a white pullover hoodie on a hanger. The provided logo is printed large on the center chest area.',
            attributes: { color: 'white', style: 'Pullover' },
        },
        {
            id: 'hoodie-white-zipup',
            name: 'White, Zip-Up',
            imageUrl: 'https://picsum.photos/seed/hoodie-white-zipup/300/300',
            prompt: 'A studio shot of a white zip-up hoodie, zipped up and laid flat. The provided logo is on the left chest.',
            attributes: { color: 'white', style: 'Zip-Up' },
        },
        {
            id: 'hoodie-navy-pullover',
            name: 'Navy, Pullover',
            imageUrl: 'https://picsum.photos/seed/hoodie-navy-pullover/300/300',
            prompt: 'A lifestyle shot of a folded navy blue pullover hoodie on a wooden background. The provided logo is printed large on the center chest area.',
            attributes: { color: 'navy', style: 'Pullover' },
        },
        {
        ...
        {
            id: 'hoodie-red-pullover',
            name: 'Red, Pullover',
            imageUrl: 'https://picsum.photos/seed/hoodie-red-pullover/300/300',
            prompt: 'A vibrant product shot of a red pullover hoodie worn by a mannequin against a gray wall. The provided logo is printed on the chest.',
            attributes: { color: 'red', style: 'Pullover' },
        },
        {
            id: 'hoodie-red-zipup',
            name: 'Red, Zip-Up',
            imageUrl: 'https://picsum.photos/seed/hoodie-red-zipup/300/300',
            prompt: 'A studio shot of a red zip-up hoodie, zipped up and laid flat. The provided logo is on the left chest.',
            attributes: { color: 'red', style: 'Zip-Up' },
        },
    ]
  },
  {
